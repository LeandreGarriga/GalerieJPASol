...
public class TableauController {
     ...
     * @param redirectInfo pour      * @return une redirection vers l'affichage de la table des tableaux
transmettre des paramètres lors de la redirection
     * @return 
     */
    @PostMapping(path = "save")
    public String ajouteLeTableauPuisMontreLaTable(Tableau tableau, RedirectAttributes redirectInfo) {
        String message;
        try {
     ...
     * chercher la table dans la base
     * @param redirectInfo pour transmettre des paramètres lors de la redirection
     * @return une redirection vers l'affichage de la table des tableaux
     */
    ...
    public String supprimeUneCategoriePuisMontreLaListe(@RequestParam("id") Tableau tableau, RedirectAttributes redirectInfo) {
        ...
        try {
            dao.delete(tableau); // Ici on peut avoir une erreur (Si il y a un auteur pour ce tableau par exemple)
        } catch (DataIntegrityViolationException e) {
        ...
        redirectInfo.addFlashAttribute("message", message);
        return "redirect:show"; // on se redirige vers l'affichage de la table
    }
}
